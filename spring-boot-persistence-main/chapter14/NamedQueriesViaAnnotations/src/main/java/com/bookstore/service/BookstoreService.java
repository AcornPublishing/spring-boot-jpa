...
public class BookstoreService {
    ...
    public List<Author> fetchAuthorsViaSortNative() {
        return authorRepository.fetchViaSortNative(Sort.by(Sort.Direction.DESC, "name"));
    }
    //*/

    /* exception
    public List<Author> fetchAuthorsViaSortWhereNative() {
        return authorRepository.fetchViaSortWhereNative(30, Sort.by(Sort.Direction.DESC, "name"));
    }
    //*/
